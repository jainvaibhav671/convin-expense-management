...
export default function ExpenseList() {
    ...
    return (
        <div className="flex-grow px-2 py-12 w-10/12 flex flex-col gap-4 text-center">
            <div className="w-full flex items-center justify-between">
                <h2 className="text-2xl font-bold">Expenses</h2>
                <Button size="sm" variant="default" asChild><Link to="/add-expense">Add <PlusIcon /></Link></Button>
            </div>
